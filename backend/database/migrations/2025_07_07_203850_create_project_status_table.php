...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ProjectStatus', function (Blueprint $table) {
            $table->ulid('project_status_id')->primary(); // Identificador único del estado del proyecto

            $table->string('name'); // Nombre del estado del proyecto
            $table->text('description')->nullable(); // Descripción del estado del proyecto
